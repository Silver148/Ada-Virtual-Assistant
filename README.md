...
> **Note for cross-compiling for Windows:** If you are compiling for Windows from Linux, I recommend download the custom MinGW-w64 toolchain [here](https://github.com/Silver148/MinGW-w64-Toolchain/releases). This package features the latest experimental GCC from the main branch, complete with POSIX threads and OpenMP support.
