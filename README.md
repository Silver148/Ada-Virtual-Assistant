...
> **Note for cross-compiling for Windows:** If you are compiling Ada for Windows from Linux, I recommend download the custom MinGW-w64 toolchain [here](https://github.com). This package features the latest experimental GCC from the main branch, complete with POSIX threads and OpenMP support, which is highly recommended for building this project smoothly.
